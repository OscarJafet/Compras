 ...
 * @author Jose
 */
public class C_IMAGENESProducto extends javax.swing.JPanel {

    /**
     * Creates new form Percepciones1
     */
    Conexion erp;
    public C_IMAGENESProducto() {
        initComponents();
        erp = new Conexion();
...
"from imagenesproducto i inner join productos pd on i.idproducto= pd.idproducto where i.principal='A'" ;
    ...
    private void initComponents() {
        ...
        btnConsultarSucursal.setBounds(680, 20, 60, 50);
        ...
        tblContactos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID ", "NOMBREIMAGEN", "PRINCIPAL", "PRODUCTO"
            }
        ) {
        ...
        add(jLabel1);
        jLabel1.setBounds(40, 30, 144, 16);
    ...
    private void btnEliminarPercepcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarPercepcionActionPerformed
        ...
        if (con>=0){
            ...
            String es= String.valueOf(tblContactos.getValueAt(con,2));
            if(es.equals("A"))
            {
            ...
            if(JOptionPane.showConfirmDialog (null, "Desea eliminar","Informacion",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {
                ID = Integer.parseInt(tblContactos.getValueAt(tblContactos.getSelectedRow(),0).toString());
           erp.OpenCon("ERP", "erp");
           erp.SQL("update imagenesproducto set principal='B' where idimagen="+ID);
...
"from imagenesproducto i inner join productos pd on i.idproducto= pd.idproducto  where pd.nombre like '" +a.toString()
    ...
    private void tblContactosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblContactosMouseEntered
         borrarTabla(tblContactos);
      erp.OpenCon("ERP", "erp");
         tblContactos.setVisible(false);
